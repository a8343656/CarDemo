...
public abstract class AbstractMotorclycle extends AbstractRoadVehicle{
	
	public AbstractMotorclycle(String brand, String type, String startType,String color, Energy energy, 
			Integer speed,
	...
	public void start(){
		if(getEnergyLeft()>0){
			...
			setStart(false);
			System.out.println(getEnergy().getType()+"不足，摩托車啟動失敗");
		}
